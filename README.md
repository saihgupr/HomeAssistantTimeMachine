...
*   **Signed Tags:** New releases (starting with [identity-proof-v1](https://codeberg.org/DiggingForDinos/HomeAssistantTimeMachine/releases/tag/identity-proof-v1)) are GPG-signed by the new `DiggingForDinos` identity.
